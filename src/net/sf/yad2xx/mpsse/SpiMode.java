 ...
 */
public enum SpiMode {
	M0(false, MSB_FIRST_BYTE_IN_POS_EDGE.getValue(), MSB_FIRST_BIT_IN_POS_EDGE.getValue(), 
	...
	M1(false, MSB_FIRST_BYTE_IN_POS_EDGE.getValue(), MSB_FIRST_BIT_IN_POS_EDGE.getValue(), 
			  MSB_FIRST_BYTE_OUT_NEG_EDGE.getValue(), MSB_FIRST_BIT_OUT_NEG_EDGE.getValue(),
			  MSB_FIRST_BYTE_INOUT_POSNEG_EDGE.getValue(), MSB_FIRST_BIT_INOUT_POSNEG_EDGE.getValue()),
	M2(true, MSB_FIRST_BYTE_IN_NEG_EDGE.getValue(), MSB_FIRST_BIT_IN_NEG_EDGE.getValue(),
	...
	M3(true, MSB_FIRST_BYTE_IN_NEG_EDGE.getValue(), MSB_FIRST_BIT_IN_NEG_EDGE.getValue(),
			 MSB_FIRST_BYTE_OUT_POS_EDGE.getValue(), MSB_FIRST_BIT_OUT_POS_EDGE.getValue(),
			 MSB_FIRST_BYTE_INOUT_NEGPOS_EDGE.getValue(), MSB_FIRST_BIT_INOUT_NEGPOS_EDGE.getValue());
